...
foreign import ccall unsafe "windows.h RegCloseKey"
...
foreign import ccall unsafe "windows.h RegConnectRegistryW"
...
regCreateKey key subkey =
  ...
  p_new_key <- peek p_out_key
  newForeignHANDLE p_new_key
foreign import ccall unsafe "windows.h RegCreateKeyW"
...
foreign import ccall unsafe "windows.h RegCreateKeyExW"
...
foreign import ccall unsafe "windows.h RegDeleteKeyW"
...
foreign import ccall unsafe "windows.h RegDeleteValueW"
...
foreign import ccall unsafe "windows.h RegEnumKeyW"
...
foreign import ccall unsafe "windows.h RegEnumValueW"
...
foreign import ccall unsafe "windows.h RegFlushKey"
...
foreign import ccall unsafe "windows.h RegLoadKeyW"
...
foreign import ccall unsafe "windows.h RegNotifyChangeKeyValue"
...
foreign import ccall unsafe "windows.h RegOpenKeyW"
...
regOpenKeyEx key subkey sam =
  ...
  p_res_key <- peek p_res
  newForeignHANDLE p_res_key
foreign import ccall unsafe "windows.h RegOpenKeyExW"
...
foreign import ccall unsafe "windows.h RegQueryInfoKeyW"
...
regQueryValueKey key mb_subkey =
  ...
  allocaArray0 (fromIntegral value_len) $ \ c_value -> do
    ...
    peekTString c_value
foreign import ccall unsafe "windows.h RegQueryValueW"
...
foreign import ccall unsafe "windows.h RegReplaceKeyW"
...
foreign import ccall unsafe "windows.h RegRestoreKeyW"
...
foreign import ccall unsafe "windows.h RegSaveKeyW"
...
foreign import ccall unsafe "windows.h RegSetValueW"
...
foreign import ccall unsafe "windows.h RegUnLoadKeyW"
