...
foreign import ccall unsafe "windows.h CreateBitmap"
...
foreign import ccall unsafe "windows.h CreateBitmapIndirect"
...
foreign import ccall unsafe "windows.h CreateCompatibleBitmap"
...
foreign import ccall unsafe "windows.h CreateDIBPatternBrushPt"
...
getBitmapDimensionEx bm =
  ...
  peekSIZE p_size
foreign import ccall unsafe "windows.h GetBitmapDimensionEx"
...
setBitmapDimensionEx bm (cx,cy) =
  ...
  peekSIZE p_size
foreign import ccall unsafe "windows.h SetBitmapDimensionEx"
...
getBitmapInfo bm =
  ...
  peekBITMAP p_bm
foreign import ccall unsafe "windows.h GetObjectW"
...
foreign import ccall unsafe "windows.h GetDIBits"
...
foreign import ccall unsafe "windows.h SetDIBits"
...
foreign import ccall unsafe "windows.h CreateDIBitmap"
