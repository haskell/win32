...
foreign import ccall unsafe "windows.h CombineRgn"
...
foreign import ccall unsafe "windows.h OffsetRgn"
...
foreign import ccall unsafe "windows.h GetRgnBox"
...
foreign import ccall unsafe "windows.h CreateEllipticRgn"
...
createEllipticRgnIndirect rp = do
  ...
  newForeignHANDLE ptr
foreign import ccall unsafe "windows.h CreateEllipticRgnIndirect"
...
createRectRgn x0 y0 x1 y1 = do
  ...
  newForeignHANDLE ptr
foreign import ccall unsafe "windows.h CreateRectRgn"
...
createRectRgnIndirect rp = do
  ...
  newForeignHANDLE ptr
foreign import ccall unsafe "windows.h CreateRectRgnIndirect"
...
createRoundRectRgn x0 y0 x1 y1 h w = do
  ...
  newForeignHANDLE ptr
foreign import ccall unsafe "windows.h CreateRoundRectRgn"
...
createPolygonRgn ps mode =
  ...
  newForeignHANDLE ptr
foreign import ccall unsafe "windows.h CreatePolygonRgn"
  c_CreatePolygonRgn :: Ptr POINT -> Int -> PolyFillMode -> IO PRGN

-- Needs to do proper error test for EqualRgn; GSL ???

foreign import ccall unsafe "windows.h EqualRgn"
...
foreign import ccall unsafe "windows.h FillRgn"
...
foreign import ccall unsafe "windows.h InvertRgn"
...
foreign import ccall unsafe "windows.h PaintRgn"
...
foreign import ccall unsafe "windows.h FrameRgn"
...
foreign import ccall unsafe "windows.h PtInRegion"
...
foreign import ccall unsafe "windows.h RectInRegion"
